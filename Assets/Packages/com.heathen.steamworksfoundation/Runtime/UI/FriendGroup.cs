...
namespace HeathenEngineering.SteamworksIntegration.UI
{
    ...
    public class FriendGroup : MonoBehaviour
    {
        ...
        private bool IsFriend(CSteamID steamId)
        {
            // Get the relationship between the local user and the specified Steam ID
            EFriendRelationship relationship = SteamFriends.GetFriendRelationship(steamId);

            // Check if the relationship is 'Friend'
